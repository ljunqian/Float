...
export interface TypographyProps extends ssTypographyProps {
    textTransform?: ResponsiveValue<Pick<TextStyle, 'textTransform'>['textTransform']>;
    textDecorationColor?: ResponsiveValue<Pick<TextStyle, 'textDecorationColor'>['textDecorationColor']>;
    textDecorationStyle?: ResponsiveValue<Pick<TextStyle, 'textDecorationStyle'>['textDecorationStyle']>;
    textDecorationLine?: ResponsiveValue<Pick<TextStyle, 'textDecorationLine'>['textDecorationLine'] | string>;
    /**
